# Cloud & IaaS Basics - Module Notes & Exercises

After completing this module I can:
- Provision and configure a cloud server on DigitalOcean (Droplet)
- Secure a server with firewall rules, opening only required ports
- Deploy and run a Node.js application on a remote cloud server
- Transfer files to a remote server using scp
- Create a non-root user with sudo privileges for safer server access
- Connect to remote servers via SSH using key-based authentication
...
git remote add origin git@github.com:elemasamuel/devops-bootcamp-05-cloud-iaas-basics.git
